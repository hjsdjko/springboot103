...
public class ShangjiaController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        if(u==null || !u.getShangjiamima().equals(EncryptUtil.md5(password))) {
    ...
    public R register(@RequestBody ShangjiaEntity shangjia){
		...
		shangjia.setId(uId);
        shangjia.setShangjiamima(EncryptUtil.md5(shangjia.getShangjiamima()));
    ...
    public R resetPass(String username, HttpServletRequest request){
        ...
        u.setShangjiamima(EncryptUtil.md5("123456"));
    ...
    public R update(@RequestBody ShangjiaEntity shangjia, HttpServletRequest request){
        ...
        if(StringUtils.isNotBlank(shangjia.getShangjiamima()) && !shangjia.getShangjiamima().equals(shangjiaEntity.getShangjiamima())) {
            shangjia.setShangjiamima(EncryptUtil.md5(shangjia.getShangjiamima()));
        }
